...
public class LeagueManager {
	...
	public String getTableAsString() {
		...
		sb.append("<html><body style='background-color: #2b2b2b; color: #ffffff; font-family: sans-serif; padding: 15px; width: 330px;'>");
		...
		sb.append("<th style='padding-bottom: 5px;'></th><th>DRUYŻYNA</th><th>MR</th><th>W</th><th>R</th><th>P</th><th>PKT</th><th>RG</th><th>$$$</th>");
		sb.append("</tr>");
		...
		for (int i = 0; i < teams.size(); i++) {
            ...
            sb.append("<td style='white-space: nowrap;'>").append(team.getBudget() / 1000).append("k $</td>");
            sb.append("</tr>");
		}
